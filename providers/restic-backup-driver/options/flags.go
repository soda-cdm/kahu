...
// resticServiceFlags defines flags for NFS Services
type resticServiceFlags struct {
	UnixSocketPath  string
	ProviderName    string
	ProviderVersion string
}

// NewResticServiceFlags creates new NFS Service flags
func newResticServiceFlags() *resticServiceFlags {
	return &resticServiceFlags{
		UnixSocketPath: unixSocketPath,
	}
}

// AddFlags exposes available command line options
func (options *resticServiceFlags) addFlags(fs *pflag.FlagSet) {
...
func (options *resticServiceFlags) apply() error {
