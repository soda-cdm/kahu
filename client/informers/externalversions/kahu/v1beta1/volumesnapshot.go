	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.KahuV1beta1().VolumeSnapshots().List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KahuV1beta1().VolumeSnapshots().Watch(context.TODO(), options)
			},
		},
		&kahuv1beta1.VolumeSnapshot{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *volumeSnapshotInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&kahuv1beta1.VolumeSnapshot{}, f.defaultInformer)
}
