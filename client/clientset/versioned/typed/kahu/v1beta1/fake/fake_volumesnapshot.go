...
var volumesnapshotsResource = schema.GroupVersionResource{Group: "kahu.io", Version: "v1beta1", Resource: "volumesnapshots"}

var volumesnapshotsKind = schema.GroupVersionKind{Group: "kahu.io", Version: "v1beta1", Kind: "VolumeSnapshot"}
...
func (c *FakeVolumeSnapshots) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.VolumeSnapshot, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(volumesnapshotsResource, name), &v1beta1.VolumeSnapshot{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeVolumeSnapshots) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.VolumeSnapshotList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(volumesnapshotsResource, volumesnapshotsKind, opts), &v1beta1.VolumeSnapshotList{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeVolumeSnapshots) Create(ctx context.Context, volumeSnapshot *v1beta1.VolumeSnapshot, opts v1.CreateOptions) (result *v1beta1.VolumeSnapshot, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(volumesnapshotsResource, volumeSnapshot), &v1beta1.VolumeSnapshot{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1beta1.VolumeSnapshot), err
...
func (c *FakeVolumeSnapshots) Update(ctx context.Context, volumeSnapshot *v1beta1.VolumeSnapshot, opts v1.UpdateOptions) (result *v1beta1.VolumeSnapshot, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(volumesnapshotsResource, volumeSnapshot), &v1beta1.VolumeSnapshot{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1beta1.VolumeSnapshot), err
...
func (c *FakeVolumeSnapshots) UpdateStatus(ctx context.Context, volumeSnapshot *v1beta1.VolumeSnapshot, opts v1.UpdateOptions) (*v1beta1.VolumeSnapshot, error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateSubresourceAction(volumesnapshotsResource, "status", volumeSnapshot), &v1beta1.VolumeSnapshot{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1beta1.VolumeSnapshot), err
...
func (c *FakeVolumeSnapshots) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteAction(volumesnapshotsResource, name), &v1beta1.VolumeSnapshot{})
	return err
}
...
func (c *FakeVolumeSnapshots) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewRootDeleteCollectionAction(volumesnapshotsResource, listOpts)
...
func (c *FakeVolumeSnapshots) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.VolumeSnapshot, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(volumesnapshotsResource, name, pt, data, subresources...), &v1beta1.VolumeSnapshot{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1beta1.VolumeSnapshot), err
