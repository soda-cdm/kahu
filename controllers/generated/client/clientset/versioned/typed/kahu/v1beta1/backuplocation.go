...
// Code-generator(client-gen) is contributed by Kubernetes Authors.
...
import (
	...
	scheme "github.com/soda-cdm/kahu/controllers/generated/client/clientset/versioned/scheme"
...
func (c *backupLocations) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.BackupLocationList, err error) {
...
func (c *backupLocations) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *backupLocations) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
