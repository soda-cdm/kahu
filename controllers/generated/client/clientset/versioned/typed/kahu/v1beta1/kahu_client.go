...
import (
	...
	"github.com/soda-cdm/kahu/controllers/generated/client/clientset/versioned/scheme"
...
// NewForConfigAndClient creates a new KahuV1beta1Client for the given config and http client.
// Note the http client provided takes precedence over the configured transport values.
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*KahuV1beta1Client, error) {
	config := *c
	if err := setConfigDefaults(&config); err != nil {
		return nil, err
	}
